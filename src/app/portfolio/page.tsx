          ...
          <div className="flex flex-col items-center relative w-full">
            ...
            <div className="flex items-center gap-4 justify-center w-full mt-6 mb-2">
              <div className="w-6 h-6 flex items-center justify-center">
                <Link href="https://www.instagram.com/egi_danuajisantoso" target="_blank">
              ...
              <div className="w-6 h-6 flex items-center justify-center">
                <Link href="https://github.com/EgiDanuajisantosoo" target="_blank">
              ...
              <div className="w-6 h-6 flex items-center justify-center">
                <Link href="https://www.linkedin.com/in/egi-danuajisantoso" target="_blank">
              ...
              <div className="w-6 h-6 flex items-center justify-center">
                <Link href="https://discord.com/users/688864050989367357" target="_blank">
              ...
              <div className="w-7 h-7 flex items-center justify-center">
                <Link href="https://open.spotify.com/user/f9ui57alw48v8z4oba6z9hdde?si=66ebe92df1f94125" target="_blank">
        ...
        <div className="text-white w-full max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-10">
            ...
            <div className="bg-[#1a2b50] rounded-lg shadow-md p-6 flex flex-col items-center">
              ...
              <div className="w-full bg-gray-700 rounded-full h-3 mb-2">
                <div className="bg-[#000000] h-3 rounded-full transition-all" style={{ width: '50%' }} />
              </div>
        ...
        <div className="text-white w-full max-w-3xl mx-auto">
          ...
          <div className="space-y-8 sm:space-y-10">
            ...
            <div className="px-2 sm:px-8">
              ...
              <Link href='' className="text-gray-400 tracking-wider text-sm sm:text-base">
