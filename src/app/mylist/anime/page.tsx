                                ...
                                <div key={`req-${item.id}`} className="bg-surface-container border border-outline rounded-none overflow-hidden flex flex-col hover:border-secondary transition-all duration-300 transform hover:scale-[1.02] group">
                                    <div className="flex items-start gap-6 p-6">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <h3 className="font-display text-[18px] md:text-[20px] uppercase tracking-[1.5px] text-text-primary mb-2 group-hover:text-secondary group-hover:scale-105 origin-left transition-all duration-300 line-clamp-2">{item.title}</h3>
                                            <div className="flex flex-wrap items-center gap-2 mb-3 font-label-md uppercase tracking-[2px] text-[10px] text-text-secondary">
                                                {item.year && (
                                                    <span className="bg-surface-container border border-outline px-2 py-1 group-hover:border-secondary group-hover:text-secondary group-hover:scale-105 transition-all duration-300 inline-block whitespace-nowrap">
                                                        {item.year}
                                                    </span>
                                                )}
                                                {item.genre && (
                                            ...
                                            <p className="font-body-md text-text-secondary line-clamp-2 group-hover:text-secondary group-hover:scale-105 origin-left transition-all duration-300">{item.synopsis || dict.recBySomeone}</p>
                                        </div>
                                    </div>
