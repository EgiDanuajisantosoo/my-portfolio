...
export async function addAnime(formData: FormData) {
  ...
  const supabase = createClient(
    ...
    process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY!, // server action: WAJIB pakai service role
    {
      auth: { persistSession: false }
    }
  );
  // Data harus SAMA persis dengan kolom tabel "hobbies"
  const data = {
    type_hobbies: "anime",
    type: "request",
